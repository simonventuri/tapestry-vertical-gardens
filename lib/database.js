...
export async function updateProject(id, data) {
    ...
    const updateData = {
        ...
        images: JSON.stringify(images || JSON.parse(existingProject.images || '[]')),
        features: JSON.stringify(features || JSON.parse(existingProject.features || '[]')),
        plants: JSON.stringify(plants || JSON.parse(existingProject.plants || '[]')),
